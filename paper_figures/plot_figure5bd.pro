...
pro plot_figure5bd, postscript=postscript
	...
	cgColorbar, Range=[min_em, max_em], $
       OOB_Low='rose', OOB_High='charcoal', title='Emission measure (cm!U-5!N)', $
       position = [0.1, 0.86, 0.9, 0.87 ], charsize=1.2, /top, color=0	
	...
	cgColorbar, Range=[min_em, max_em], $
       OOB_Low='rose', OOB_High='charcoal', title='  ', $
       position = [0.1, 0.86, 0.9, 0.87 ], charsize=1.2, /top, color=0, xtickformat='(A1)'
