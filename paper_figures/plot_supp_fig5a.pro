...
pro plot_supp_fig5a, date = date, xwin = xwin, $
            zoom=zoom, parallelise=parallelise, winnum=winnum, $
            hot = hot, postscript=postscript, im_type=im_type, folder=folder

    ; Adaptation to plot Figure 5a of pulsation paper. Run:
    ; plot_supp_fig5a, date = '2014-04-18', /xwin, /zoom, im_type='total_b'        
...
;-
    ...
    aia_process_suppfig5a, fls_211[index], fls_211[index-5], i_a, i_a_pre, iscaled_a, im_type, imsize = array_size
    aia_process_suppfig5a, fls_193[index], fls_193[index-5], i_b, i_b_pre, iscaled_b, im_type, imsize = array_size
    aia_process_suppfig5a, fls_171[index], fls_171[index-5], i_c, i_c_pre, iscaled_c, im_type, imsize = array_size
