...
pro plot_spec, data, time, freqs, frange, trange, scl0=scl0, scl1=scl1
	...
	cgColorbar, Range=[scl0, scl1], $
       ...
       position = [0.91, 0.1, 0.925, 0.95 ], charsize=1.0, color=0, OOB_FACTOR=0.0, format='(f3.1)', $
       TICKINTERVAL = 0.2
	...
	reverse_ct
  	cgColorbar, Range=[scl0, scl1], $
       ...
       position = [0.91, 0.1, 0.925, 0.95 ], charsize=1.0, color=100, ytickformat='(A1)', OOB_FACTOR=0.0, format='(f3.1)', $
       TICKINTERVAL = 0.2
