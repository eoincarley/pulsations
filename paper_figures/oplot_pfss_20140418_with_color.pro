pro oplot_pfss_20140418_with_color
	...
	for j=0, 1 do begin
        ...
        ; 	
        bcent=-5.36
        lcent=216.191 - 2.9e-6*!radeg*60.*60.*6.75	; First number from pfss_viewer, for 06:00 UT on the day. Because the image is at 12, multiply by solar angular velocity and 6 hours
        cb=cos(bcent(0)*!dtor)
        sb=-sin(bcent(0)*!dtor)
  ...
  save, xlines_total, ylines_total, field_strength_total, $
            filename = '~/pfss_line_strength_test.sav'
