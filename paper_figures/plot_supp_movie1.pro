...
pro plot_supp_movie1, postscript=postscript
    ...
    !p.charsize=1.5 
    time_start = anytim('2014-04-18T12:54:00.000', /utim)   ;anytim(file2time('20140418_125000'), /utim)    ;anytim(file2time('20140418_125546'), /utim)    ;anytim(file2time('20140418_125310'), /utim)
    time_end =  anytim('2014-04-18T12:58:00.000', /utim)    ;anytim(file2time('20740418_125440'), /utim)   ;anytim(file2time('20140418_125650'), /utim)        ;anytim(file2time('20140418_125440'), /utim) 
    FOV = [15, 15]
    CENTER = [0.0, -300.0]
    nlevels=5.0   
    top_percent = 0.6   ; Contour levels    
    ...
    for k=0, n_elements(nrh_hdrs)-1 do begin	
		...
		for i=0, n_elements(xlines_total)-1 do begin
			...
			ylines = YLINES_TOTAL[i]
		 	plots, xlines<450, ylines>(-750)<150, col=1, thick=2.5
		 	plots, xlines<450, ylines>(-750)<150, col=10, thick=1.5
	    endfor 	  			

		orfees_plot_pulsations, 208, anytim(nrh_time, /utim), [time_start, time_end]
...
stop    		
	spawn, "ffmpeg -y -r 20 -i image_%04d.png -vb 50M nrh_orfees_pulse_hi_res-vfast.mpg"
STOP
END