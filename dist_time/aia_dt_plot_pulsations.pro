...
pro aia_dt_plot_three_color, angle, postscript=postscript, choose_points=choose_points, ratio=ratio
	...
	;restore, 'aia_'+waves[0]+'_pulsations.sav', /verbose
	restore,'aia_'+waves[0]+'_dt_map_gcircle.sav' 
	...
	;restore, 'aia_'+waves[1]+'_pulsations.sav', /verbose
	restore,'aia_'+waves[1]+'_dt_map_gcircle.sav' 
	...
	;restore, 'aia_'+waves[2]+'arc_dt_map.sav', /verbose
	;restore, 'aia_'+waves[2]+'_pulsations.sav', /verbose	
	restore,'aia_'+waves[2]+'_dt_map_gcircle.sav' 
	...
	;for i=0, n_elements(plota[*, 0])-1 do plota[i, *] = smooth(plota[i, *], 20)
	;for i=0, n_elements(plotb[*, 0])-1 do plotb[i, *] = smooth(plotb[i, *], 20)
	;for i=0, n_elements(plotc[*, 0])-1 do plotc[i, *] = smooth(plotc[i, *], 20)
